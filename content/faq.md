...
This blog is written in R using the [`{blogdown}` package](https://bookdown.org/yihui/blogdown/){:target="_blank"} and Hugo, and deployed and hosted via Netlify. The code can be found on [GitHub](https://github.com/AntoineSoetewey/statsandr){:target="_blank"}.
