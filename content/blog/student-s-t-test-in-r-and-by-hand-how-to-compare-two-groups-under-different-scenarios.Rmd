...
This concludes a relatively long article. Thanks for reading it. I hope this article helped you to understand how the different versions of the Student's t-test for two samples work and how to perform them by hand and in R. If you are interested, here is a [Shiny app](/blog/a-shiny-app-for-inferential-statistics-by-hand/) to perform these tests by hand easily (you just need to enter your data and select the appropriate version of the test thanks to the sidebar menu). Moreover, read [this article](/blog/how-to-perform-a-one-sample-t-test-by-hand-and-in-r-test-on-one-mean/) if you would like to know how to compute the Student's t-test but this time, for one sample.
