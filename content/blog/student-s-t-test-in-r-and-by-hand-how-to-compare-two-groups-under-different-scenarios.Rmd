...
Moreover, I invite you to read [this article](/blog/how-to-perform-a-one-sample-t-test-by-hand-and-in-r-test-on-one-mean/) if you would like to know how to compute the Student's t-test but this time, for one sample, or this [article](/blog/wilcoxon-test-in-r-how-to-compare-2-groups-under-the-non-normality-assumption/) if you would like to compare 2 groups under the non-normality assumption.
