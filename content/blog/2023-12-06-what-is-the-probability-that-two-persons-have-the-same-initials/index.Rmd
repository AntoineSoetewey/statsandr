...
This problem could be answered using [probability theory](/blog/the-9-concepts-and-formulas-in-probability-that-every-data-scientist-should-know/), but given that the project requires the use of simulations, I thought that it would be nice to answer this question via simulations in R.
