...
Given that the project requires the use of simulations, I decided to focus on answering this question via simulations in R. That being said, we also verify results obtained through simulations with results using probability theory. This comparison will allow to assess the truthfulness of results obtained through simulations.
