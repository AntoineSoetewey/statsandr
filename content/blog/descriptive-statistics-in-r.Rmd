...
Histograms are a bit similar to barplots, but histograms are used for quantitative variables whereas barplots are used for qualitative variables. To draw an histogram in R, use `hist()`:
...
Boxplots are really useful in descriptive statistics and are often underused. It allows to 
