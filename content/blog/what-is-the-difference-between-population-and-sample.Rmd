...
The two measurements for each individual (hours of sleep before and after the sleeping pill, or the strength in the right and left arm) and the two samples are of course related. Statistical tools accounting for a relation between the samples exist and should be preferred in that case.
...
Thanks for reading. I hope the article helped you to understand the difference between population and sample. For the interested reader, see the most common [descriptive statistics](/blog/descriptive-statistics-by-hand/) that can be made on a sample or a population.
