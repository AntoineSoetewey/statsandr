...
**The issue has been documented on [GitHub](https://github.com/renanxcortes/springerQuarantineBooksR/issues/53){target="_blank"} and the code will be updated accordingly as soon as a solution is found. Apologies for the inconvenience, and we hope that you downloaded these books in time.**

**In the meantime, you can still download books one by one through the links included in the [dynamic table](/blog/a-package-to-download-free-springer-books-during-covid-19-quarantine/#create-a-table-of-springer-books).**
...
* allow searching a book by its title, author or year,
