...
* Add the possibility to choose the format of the books (PDF, EPUB or both). Currently, it is only possible to download the PDF version.
* Add the possibility to download all editions of a book. Currently, only the latest edition can be downloaded.
* Add the possibility to download the German books too. Currently, only the English books can be downloaded.
