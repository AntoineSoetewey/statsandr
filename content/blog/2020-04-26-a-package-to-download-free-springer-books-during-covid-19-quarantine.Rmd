...
With this large collection of high quality resources and my collection of [top R resources about the Coronavirus](https://www.statsandr.com/blog/top-r-resources-on-covid-19-coronavirus/), we do not have any excuse to not read and learn during this quarantine. 
...
You can load into an R session a table contaning all the titles made available by Springer, with the `download_springer_table()` function:
