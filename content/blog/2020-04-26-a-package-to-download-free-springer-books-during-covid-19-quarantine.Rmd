...
**Update: Springer has recently added a reCAPTCHA step that is preventing automatic downloads of their books. Therefore, the code below is not working properly anymore.**

**The issue has been documented on [GitHub](https://github.com/renanxcortes/springerQuarantineBooksR/issues/53){target="_blank"} and the article will be updated accordingly as soon as a solution is found. Apologies for the inconvenience, and we hope that you downloaded these books in time.**

**If you did not download the books in time, you can download all of them [here](https://drive.google.com/drive/u/0/folders/1fD1csbKVIdfKvzLoLbIjnryae1u995YQ){target="_blank"}, or one by one via this [dynamic table](/blog/a-package-to-download-free-springer-books-during-covid-19-quarantine/#create-a-table-of-springer-books).**
