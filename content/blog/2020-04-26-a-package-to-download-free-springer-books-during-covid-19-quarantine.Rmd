...
In this article, I show how to download (i) all available textbooks at once and (ii) how to download books by title, author or subject. Without further ado, here is how the package works in practice.
...
Like me, if you do not know which books are offered by Springer, you may want to have an overview before downloading any of them. For this, you can load into an R session a table containing all the titles made available by Springer, with the `download_springer_table()` function:
