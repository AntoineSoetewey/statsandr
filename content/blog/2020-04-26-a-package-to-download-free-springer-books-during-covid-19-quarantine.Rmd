...
springer_table <- springer_table[, c(1, 2, 19, 20)]
...
If you are interested to download more than one, run the following command:

```{r, eval = FALSE}
download_springer_book_files(springer_books_titles = c("All of Statistics",
