...
(See [how to install R and RStudio](/blog/how-to-install-r-and-rstudio/) if needed.)
...
In step 10, make sure that the current repository (top left) is the repo you are currently working on.
...
After your script is saved, **do not forget to commit the changes and push the commit** (see step 10).
