...
With [45 articles](/blog/) published and topics ranging from [descriptive statistics](/blog/descriptive-statistics-in-r/), [probability](/blog/the-9-concepts-and-formulas-in-probability-that-every-data-scientist-should-know/), [inferential statistics](/blog/student-s-t-test-in-r-and-by-hand-how-to-compare-two-groups-under-different-scenarios/) to [R Markdown](/tags/r-markdown/) and [data visualization](/blog/graphics-in-r-with-ggplot2/), I have seen many benefits of sharing my code through a technical blog. In this article, I highlight 7 of them (in no particular order) with the hope that it will give ideas and incentives to some of you.
