...
Note that the $p$-value is slightly different because Yates' continuity correction is not applied in `ggpiestats()` while it is applied by default in `prop.test()`.
...
Thanks for reading. I hope this article helped you to understand and perform the one-proportion and chi-square goodness of fit test in R and by hand.
