...
Note that when the sample size is large (usually *n > 30*), the Student's t distribution tends to a normal distribution. Using a normal distribution when the variance is known and a Student's t distribution when the variance is unknown also applies to a [t-test for two samples](/blog/student-s-t-test-in-r-and-by-hand-how-to-compare-two-groups-under-different-scenarios).
