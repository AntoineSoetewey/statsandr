...
If you do not have the same results with your data, make sure to add the `correct = FALSE` argument in the `chisq.test()` function (1st method) to prevent from applying the continuity correction.
