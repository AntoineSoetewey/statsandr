...
Here is the entire code (or see the last version on [GitHub](https://github.com/AntoineSoetewey/statistics-202){target="_blank"}) in case you would like to enhance it. See an example on how to use this app after the embedded code.
