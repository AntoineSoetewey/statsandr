...
description: What are the probability of winning for each ambassador in the television show Koh-Lanta 2022? Learn how to compute it in R through simulations and examples
output:
  blogdown::html_page:
    toc: true
    toc_depth: 6  
...
You can already see that the game is in favor of Louana, as expected. Let's see now how it evolves when playing several times.
