...
After publishing this article, a reader informed me about the `{packman}` package. After having read the documentation and try it out myself, I learned that this package checks to see if a package is installed, if not it attempts to install the package and then loads it. It can also be applied to several packages at once, all this in a very condensed way:
