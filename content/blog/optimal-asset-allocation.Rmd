...
Here is the entire code (or see the last version on [GitHub](https://github.com/AntoineSoetewey/optimal-asset-allocation){target="_blank"}) in case you would like to enhance it. See an example on how to use this app after the embedded code.
...
Thanks for reading. I hope you will find this app useful to quickly replicate the optimal asset allocation suggested by Burton G. Malkiel in his book *A Random Walk down Wall Street*. If you want to have more information about this investment strategy, I suggest reading his book.
