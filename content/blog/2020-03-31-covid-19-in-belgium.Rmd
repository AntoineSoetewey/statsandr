...
* *R*: individuals who have recovered, i.e., people that were contaminated but who have either recovered or died. They are not infectious anymore.
...
Finally, the last equation (Eq. 3) states that the recovered group increases by the number of individuals who were infectious and who either recovered or died ($\gamma I$).
...
1. At the beginning of the outbrek, as soon as the first individual is infected, *S* decreases by 1 and *I* increases by 1 as well.
...
The reproduction number gives the average number of susceptible people who are infected by each infectious person. In other words, the reproduction number refers to the number of healthy people that get infected per number of sick people. When $R_0 > 1$ the disease starts spreading in a population, but not if $R_0 < 1$. Usually, the larger the value of $R_0$, the harder it is to control the epidemic and the higher the probability of pandemic.
