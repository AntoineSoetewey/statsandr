...
The advantage of a two-way over a one-way ANOVA is quite similar to the advantage of a [correlation](/blog/correlation-coefficient-and-correlation-test-in-r/) over a [multiple linear regression](/blog/multiple-linear-regression-made-simple/):
