...
Thanks for reading. I hope this article helped you to build an interactive booklist with an automated affiliate link to each of the book in your list. If you would like to see a live example, see <a href="https://www.antoinesoetewey.com/files/booklist.html" target="_blank" rel="noopener">my personal booklist</a>. See other articles related to R [here](/tags/r/).
