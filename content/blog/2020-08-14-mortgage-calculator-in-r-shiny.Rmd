...
Here is the entire code (or see the last version on [GitHub](https://github.com/AntoineSoetewey/mortgage-calculator){target="_blank"}) in case you would like to enhance it (feel free to send me your app if you happen to improve it!). See an example on how to use this app after the embedded code.
