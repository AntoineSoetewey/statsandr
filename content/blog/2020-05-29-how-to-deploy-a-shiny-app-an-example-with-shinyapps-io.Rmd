...
A reader recently asked me how to publish a [Shiny app](/tags/shiny/) she just created. Similarly to a previous article where I show [how to upload R code on GitHub](/blog/how-to-upload-r-code-on-github-example-with-an-r-script-on-mac-os/), I thought it would be useful to some people to see how I publish my Shiny apps so they could do the same.
