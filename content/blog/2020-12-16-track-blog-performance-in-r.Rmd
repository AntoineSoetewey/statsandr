...
tags:
  ...
  - Review
  - Web
meta_img: blog/2020-12-16-track-blog-performance-in-r_files/track-blog-performance-in-r-googleAnalyticsR.jpeg
...
![](/blog/2020-12-16-track-blog-performance-in-r_files/track-blog-performance-in-r-googleAnalyticsR.jpeg){width=100%}
...
Knowing **how people come to your blog** is a pretty important factor. Here is how to visualize the evolution of daily sessions per channel in a static [line plot](/blog/descriptive-statistics-in-r/#line-plot):
...
Another way to present the same information is with a [density plot](/blog/descriptive-statistics-in-r/#density-plot). In this plot, the device type has also been added to the plot for more insights.
...
The above plot shows the same results than the heatmap, that is:
