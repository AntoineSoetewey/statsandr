...
In its first year, Stats and R has attracted **`r format(gadata$users, big.mark = ",")` users**, who generated a total of **`r format(gadata$sessions, big.mark = ",")` sessions** and **`r format(gadata$pageviews, big.mark = ",")` page views** (that is an average of `r format(gadata$pageviews / (as.numeric(end_date - start_date) + 1), big.mark = ",", digits = 0)` page views per day).
