...
I am not an expert in the field of [digital marketing](https://blog.antwak.com/digital-marketing-what-does-the-profession-demand/){target="_blank"}, but who knows, it may still give some ideas to data analysts, SEO specialists or other bloggers on how to track the performance of their own blog or website using R. For those of you who are interested in a more condensed analysis, see my [custom Google Analytics dashboard](/blog/files/google-analytics-dashboard/).^[Thanks to the [RStudio blog](https://blog.rstudio.com/2021/01/06/google-analytics-part2/){target="_blank"} for the inspiration.]
