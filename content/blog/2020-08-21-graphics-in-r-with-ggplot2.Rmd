...
Depending on your data, it is possible to format the y-axis in a certain way with the `{scales}` package. The format I use the most is `comma` which formats numbers in a more-readible way:

```{r}
p + scale_y_continuous(label = scales::comma)
```
