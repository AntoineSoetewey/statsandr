...
Here I specify the number of bins to be equal to the square root of the number of observations (following the square-root rule) but you can specify any integer number.
...
If you are unhappy with the default colors, you can change them manually with the `scale_colour_manual()` layer (for qualitative variables) and the `scale_colour_gradient2()` layer (for quantitative variables):
