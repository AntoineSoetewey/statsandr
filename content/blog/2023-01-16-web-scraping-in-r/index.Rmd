...
description: Learn how to do web scraping in R through a real life example.
output:
  blogdown::html_page:
    toc: true
    toc_depth: 6
...
*This post has been written in collaboration with [Pietro Zanotta](mailto:pcs.parmigiano@gmail.com).*

# Introduction

Almost anyone is familiar with web pages (otherwise you would not be here), but what if we tell you that how you see a site is different from how Google or your browser does? In fact, when you type any site address in your browser, your browser will download and render the page for you, but for rendering the page it needs some instructions.
...
This article aims to cover the basics of how to do web scraping in R. We will conclude by creating a database on Formula 1 drivers from [Wikipedia](https://en.wikipedia.org/wiki/List_of_Formula_One_drivers).
...
Suppose that for a project you need the summaries of the articles of the NYT (note that what is in the following picture is not what you see in the [New York Times web page](https://www.nytimes.com/)).
...
As expected, there seems to be a relationship between the number of pole positions and the number of Championships won. To quantify this relationship, we could build a [linear model](/blog/multiple-linear-regression-made-simple/) but this is beyond the scope of the article.
...
-   [Web scraping: Basics](https://bookdown.org/paul/2021_computational_social_science/web-scraping-basics.html) by Paul Bauer
-   [rvest](https://cran.r-project.org/web/packages/rvest/rvest.pdf) CRAN documentation
-   [xml2](https://cran.r-project.org/web/packages/xml2/xml2.pdf) CRAN documentation
-   [httr](https://cran.r-project.org/web/packages/httr/httr.pdf) CRAN documentation
-   [rvest](https://cran.r-project.org/web/packages/rvest/vignettes/rvest.html) CRAN vignette
-   [httr](https://cran.r-project.org/web/packages/httr/vignettes/quickstart.html) CRAN vignette
-   [Beautiful Soup](https://www.crummy.com/software/BeautifulSoup/bs4/doc/) documentation
-   [RoboBrowser](https://robobrowser.readthedocs.io/en/latest/readme.html) documentation
-   [HTML](https://developer.mozilla.org/en-US/docs/Web/HTML) documentation
