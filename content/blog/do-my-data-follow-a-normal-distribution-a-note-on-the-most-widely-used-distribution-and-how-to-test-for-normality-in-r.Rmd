...
dat <- data.frame(Normal_dist1 = rnorm(1000000, mean = 100, sd = 4),
                  Normal_dist2 = rnorm(1000000, mean = 100, sd = 5),
                  Normal_dist3 = rnorm(1000000, mean = 100, sd = 6))

names(dat) <- c("variance = 16",
                "variance = 25",
                "variance = 36")
