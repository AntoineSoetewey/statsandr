...
To compute probabilities by hand, we need to refer to the standard normal distribution table shown below:

![Standard normal distribution table. Source: Wackerly et al. (2014).](/blog/do-my-data-follow-a-normal-distribution-a-note-on-the-most-widely-used-distribution-and-how-to-test-for-normality-in-r_files/Screenshot 2020-01-30 at 15.07.44.png){width=100%}
...
4. See another example in a context [here](/blog/a-guide-on-how-to-read-statistical-tables/#example/)
