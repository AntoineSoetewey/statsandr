...
From the output, we see that the $p$-value $> 0.05$ implying that we do not reject the null hypothesis that the data follow a normal distribution. the data are not significantly different from a normal distribution. This test goes in the same direction than the QQ-plot, which showed no significant deviation from the normality (as all points lied within the confidence bands).
