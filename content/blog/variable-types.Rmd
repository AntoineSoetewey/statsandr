...
In this article, we are going to focus on variables, and in particular to the different types of variable that exist in statistics. (To learn about the different data types in R, read "[Data types in R](/blog/data-types-in-r/)".)
