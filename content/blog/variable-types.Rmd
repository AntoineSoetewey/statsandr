...
For example, the variable gender is nominal because there is no order in the levels (no matter how many levels you consider for the gender---only two with female/male, or more than two with female/male/others, levels are **un**ordered). Eye color is another example of a nominal variable because there is no order among blue, brown or green eyes.
...
Similarly, some [statistical tests](/blog/what-statistical-test-should-i-do/) can only be performed on certain type of variables. For example, a [correlation](/blog/correlation-coefficient-and-correlation-test-in-r/) can only be computed on quantitative variables, while a [Chi-square test of independence](/blog/chi-square-test-of-independence-in-r/) is done with qualitative variables, and a [Student t-test](/blog/student-s-t-test-in-r-and-by-hand-how-to-compare-two-groups-under-different-scenarios/) or [ANOVA](/blog/anova-in-r/) requires a mix of quantitative and qualitative variables.
