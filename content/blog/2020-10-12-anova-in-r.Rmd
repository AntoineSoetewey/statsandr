...
A nice and easy way to report results of an ANOVA in R is with the `report()` function from the `{report}` package (we first need to install and load the `{easystats}` package):
...
As you can see, the function interprets the results for you.
