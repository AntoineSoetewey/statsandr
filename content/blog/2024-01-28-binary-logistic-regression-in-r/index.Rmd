...
We know that a linear regression is a convenient way to estimate the relationship between a [quantitative continuous](/blog/variable-types-and-examples/#continuous) dependent variable, and one or more independent variables (of any type).
...
Recall that a linear regression requires:

1. the dependent variable to be quantitative continuous
...
1. no extreme influential points (known as [outliers](/blog/outliers-detection-in-r/)), and
1. no multicollinearity (for multiple linear regression only)
