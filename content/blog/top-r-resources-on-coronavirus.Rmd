...
Part 1 is actually based on another shorter blog post by Learning Machines. See [here](https://blog.ephorie.de/epidemiology-how-contagious-is-novel-coronavirus-2019-ncov) for a more concise analysis on how to model the outbreak of the coronavirus and discover how contagious it is.
