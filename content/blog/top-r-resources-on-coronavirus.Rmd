...
![](/blog/top-r-resources-on-coronavirus_files/Comparing corona trajectories by country in R.png){width=100%}

This [Shiny app](https://andrecalerovaldez.shinyapps.io/CovidTimeSeries/) will help to compare cases and case trajectories by country. The app also allows you to compare growth rates by country via a table. 
