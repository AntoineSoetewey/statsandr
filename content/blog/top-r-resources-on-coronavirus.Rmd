...
Developed by Rami Krispin, the [`{coronavirus} package`](https://github.com/RamiKrispin/coronavirus) provides a tidy format dataset of the 2019 Novel Coronavirus COVID-19 (2019-nCoV) epidemic. Pulled from the dataset of [John Hopkins](https://github.com/CSSEGISandData/COVID-19), the R package gives a daily summary of the coronavirus cases by state/province. The data set contains various variables such as confirmed cases, death, and recovered across different states.
...
More recently, the author published two new articles modelling the effects of public health interventions on COVID-19 transmission using R. Find them [here](https://timchurches.github.io/blog/posts/2020-03-10-modelling-the-effects-of-public-health-interventions-on-covid-19-transmission-part-1/) and [here](https://timchurches.github.io/blog/posts/2020-03-18-modelling-the-effects-of-public-health-interventions-on-covid-19-transmission-part-2/). The code is also available on GitHub for the [first](https://github.com/timchurches/blog/tree/master/_posts/2020-03-10-modelling-the-effects-of-public-health-interventions-on-covid-19-transmission-part-1) and [second](https://github.com/timchurches/blog/tree/master/_posts/2020-03-18-modelling-the-effects-of-public-health-interventions-on-covid-19-transmission-part-2) part.
...
Written by Peter Ellis, this [article](http://freerangestats.info/blog/2020/03/17/covid19-cfr) focuses on how the observed case fatality rate of COVID-19 has evolved over time.
