...
Thanks for reading. I hope this article will help you to visualize correlations between variables in a dataset and to make correlation matrices more insightful and more appealing. If you want to learn more about this topic, see how to compute [correlations coefficients and correlation tests in R](/blog/correlation-coefficient-and-correlation-test-in-r/).
