...
For those interested to draw this correlogram with their own data, here is the function I adapted based on the `corrplot()` function from the `{corrplot}` package (thanks again to all contributors of this package):
...
* `diag`: display the correlation coefficients on the diagonal? `FALSE` is the default
...
Thanks for reading. I hope this article helped you to make a visualization of correlations between variables in a dataset to make correlation matrix more insightful.
