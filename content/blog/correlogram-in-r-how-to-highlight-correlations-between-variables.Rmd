...
The advantage of this alternative compared to the previous one is that it is available within a package, so you do not need to run the code of the function first in order to draw the correlogram.
