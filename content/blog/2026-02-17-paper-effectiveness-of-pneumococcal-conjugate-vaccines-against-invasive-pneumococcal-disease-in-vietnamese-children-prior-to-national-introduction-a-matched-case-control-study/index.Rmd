...
This study builds on earlier surveillance work conducted in southern Vietnam. In particular, our previous study on [Childhood bacterial meningitis surveillance in southern Vietnam](/blog/paper-childhood-bacterial-meningitis-surveillance-southern-vietnam/) (see also the associated publication in *Open Forum Infectious Diseases*: @truong2023childhood) documented trends in invasive bacterial meningitis and highlighted the persistent burden of pneumococcal disease prior to widespread PCV implementation.

The present study extends that work by moving from **surveillance and descriptive epidemiology** to **evaluation of vaccine effectiveness**.
...
Using conditional logistic regression, vaccine effectiveness was estimated as:
