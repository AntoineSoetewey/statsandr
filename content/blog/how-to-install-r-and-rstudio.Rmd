...
* Plot: where you will see the rendered plots. For instance, run `plot(1:10)` and you should see it in this tab. If you plotted more than one plots, you can naviguate between them by clicking on the arrows. You can open the plot in a new window by clicking on Zoom and export your plot by clicking on Export. Those buttons are located just under the Plot tab (see figure below)
...
Thanks for reading. I hope this article helped you to install R and RStudio. See other articles related to R [here](/tags/r/).
...
<script src="https://rssdog.com/index.php?url=https%3A%2F%2Fwww.statsandr.com%2Ftags%2Fr%2Findex.xml&mode=html&showonly=&maxitems=5&showdescs=0&desctrim=1000&descmax=0&tabwidth=100%25&linktarget=_self&textsize=inherit&bordercol=transparent&headbgcol=transparent&headtxtcol=transparent&titlebgcol=transparent&titletxtcol=%23000000&itembgcol=transparent&itemtxtcol=transparent&ctl=0"></script>

**Related articles2:**

<iframe width="100%" frameborder="0" class="rssdog" src="https://rssdog.com/index.php?url=https%3A%2F%2Fwww.statsandr.com%2Ftags%2Fr%2Findex.xml&mode=html&showonly=&maxitems=5&showdescs=0&desctrim=1000&descmax=0&tabwidth=100%25&linktarget=_self&textsize=inherit&bordercol=transparent&headbgcol=transparent&headtxtcol=transparent&titlebgcol=transparent&titletxtcol=%23000000&itembgcol=transparent&itemtxtcol=transparent&ctl=0"></iframe>

**Related articles3:**

<iframe width="100%" frameborder="0" src="https://rssdog.com/index.php?url=https%3A%2F%2Fwww.statsandr.com%2Ftags%2Fr%2Findex.xml&mode=html&showonly=&maxitems=5&showdescs=0&desctrim=1000&descmax=0&tabwidth=100%25&linktarget=_self&textsize=inherit&bordercol=transparent&headbgcol=transparent&headtxtcol=transparent&titlebgcol=transparent&titletxtcol=%23000000&itembgcol=transparent&itemtxtcol=transparent&ctl=0"></iframe>

**Related articles4:**

<iframe width="100%" height="750" frameborder="0" class="rssdog" src="https://rssdog.com/index.php?url=https%3A%2F%2Fwww.statsandr.com%2Ftags%2Fr%2Findex.xml&mode=html&showonly=&maxitems=5&showdescs=0&desctrim=1000&descmax=0&tabwidth=100%25&linktarget=_blank&textsize=inherit&bordercol=transparent&headbgcol=transparent&headtxtcol=transparent&titlebgcol=transparent&titletxtcol=%23000000&itembgcol=transparent&itemtxtcol=transparent&ctl=0"></iframe>

**Related articles5:**

<iframe width="100%" height="750" frameborder="0" class="rssdog" src="https://rssdog.com/index.php?url=https%3A%2F%2Fwww.statsandr.com%2Ftags%2Fr%2Findex.xml&mode=html&showonly=&maxitems=5&showdescs=0&desctrim=1000&descmax=0&tabwidth=100%25&linktarget=_top&textsize=inherit&bordercol=transparent&headbgcol=transparent&headtxtcol=transparent&titlebgcol=transparent&titletxtcol=%23000000&itembgcol=transparent&itemtxtcol=transparent&ctl=0"></iframe>

**Related articles6:**

<iframe width="100%" height="750" frameborder="0" class="rssdog" src="https://rssdog.com/index.php?url=https%3A%2F%2Fwww.statsandr.com%2Ftags%2Fr%2Findex.xml&mode=html&showonly=&maxitems=5&showdescs=0&desctrim=1000&descmax=0&tabwidth=100%25&linktarget=_parent&textsize=inherit&bordercol=transparent&headbgcol=transparent&headtxtcol=transparent&titlebgcol=transparent&titletxtcol=%23000000&itembgcol=transparent&itemtxtcol=transparent&ctl=0"></iframe>
