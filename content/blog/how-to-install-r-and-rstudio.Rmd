...
This means that you can now perform any computations with `a`, such that if you execute `a + 1`, RStudio will render `2` in the console. In this pane you can also see a tab with an history of the code executed and a button to import a dataset (more on [importing a dataset in RStudio here](/blog/how-to-import-an-excel-file-in-rstudio/)).

The last pane (blue) is where you will find everything else such as your files, the plots, the packages, the help documentation, etc. I discuss in more details about the Files tab [here](/blog/how-to-import-an-excel-file-in-rstudio/) so let's discuss about the other tabs:
...
Now that you have installed R and RStudio and you know 
