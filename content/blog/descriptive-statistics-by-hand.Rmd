...
Here is an example with the following series, representing the number of exams 9 students have to take in the June session:

xxx change with height of adults
...
Rounding up to the whole number gives 3 and 7, which represents the rank of the first and third quartiles. Therefore, the first quartile is 4 and the third quartile is 8.
