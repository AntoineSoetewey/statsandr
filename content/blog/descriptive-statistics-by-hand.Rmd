...
The mode is 170 because it is the most common value with 3 occurences. All other values appear only once. In conclusion, most adults of this sample are 170 cm tall. Note that it is possible that a series has no mode (e.g., `r pander(c(4,7,2,10))`) or more than one mode (e.g., `r pander(c(4, 2, 2, 8, 11, 11))`).
