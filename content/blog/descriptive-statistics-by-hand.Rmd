...
Unlike some descriptive statistics that can only be computed for quantitative variables (e.g., min, max, mean), the mode can be computed for quantitative **and** qualitative variables (see a recap of the different [types of variables](/blog/variable-types-and-examples/) if you do not remember the difference).
