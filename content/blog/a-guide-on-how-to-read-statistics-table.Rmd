...
$$X ∼ \mathcal{N}(\mu = 402, \sigma^2 = 484)$$ where $484 = 22^2$, and the solution: $$P(X > 439) = P(Z > 1.68) = 0.0463$$ where $Z = \frac{X - \mu}{\sigma} = \frac{439 - 402}{22} = 1.68$ and $Z ∼ \mathcal{N}(\mu = 0, \sigma^2 = 1)$ (known as the standard normal distribution). The probability that the cost next week exceeds the budget of 439€ is 0.0463, or 4.63%.
