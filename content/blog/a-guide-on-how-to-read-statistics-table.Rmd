...
1. Set the mean $\mu$ to 402, as it is said that the average cost is 402€
1. In the statement, the standard deviation is given so select "Standard deviation $\sigma$" and set it to 22
...
1. We are now asked to find the probability that the cost exceeds 439€, so set x to 439

The solution panel gives a recap of the data:

$$X ∼ \mathcal{N}(\mu = 402, \sigma^2 = 484)$$ where 484 is $22^2$, and the solution: $$P(X > 439) = P(Z > 1.68) = 0.0463$$ where $Z = \frac{X - \mu}{\sigma} = \frac{439 - 402}{22} = 1.68$ and $Z ∼ \mathcal{N}(\mu = 0, \sigma^2 = 1)$ (known as the standard normal distribution).
