...
1. The **Mann-Withney-Wilcoxon** test (also referred as Wilcoxon rank sum test) is performed when the samples are independent (so this test is the non-parametric equivalent to the Student's t-test for independent samples).
