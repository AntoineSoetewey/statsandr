...
* `{equatiomatic}` supports output from logistic regression as well. See all supported models in the [vignette](https://cran.r-project.org/web/packages/equatiomatic/vignettes/equatiomatic.html){target="_blank"}
