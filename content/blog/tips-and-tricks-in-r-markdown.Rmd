...
# `{pander}` for easthetics

The `pander()` function from the `{pander}` package is very useful for R Markdown documents and reporting. It is not actually a shortcut but it greatly improves the easthetics of R outputs.
