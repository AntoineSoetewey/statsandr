...
The addin I use most often is probably the [`{esquisse}` addin](/blog/rstudio-addins-or-how-to-make-your-coding-life-easier/#esquisse), which allows to draw plots with the `{ggplot2}` package in a user-friendly and interactive way, and without having to write the code myself.
