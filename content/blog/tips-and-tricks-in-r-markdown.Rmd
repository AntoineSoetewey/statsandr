...
Here is a basic example with a multiple [linear regression](/blog/multiple-linear-regression-made-simple/) using the same dataset as above (i.e., `diamonds` from `{ggplot2}`):
