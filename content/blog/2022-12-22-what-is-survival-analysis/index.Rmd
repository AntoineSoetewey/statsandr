...
* **Censoring** is almost always an issue:
  ...
  + It can also happen that the patient withdraws from the study or moves to another country (known as lost to follow up or drop out), or simply that the study ends while the patient is still alive.
