...
description: Statsandr.com is 2 years old! Learn how to track page views, sessions, users, engagement and more in R with the {googleAnayticsR} R package
output:
  blogdown::html_page:
    toc: true
    toc_depth: 6
...
For those of you who are interested in a more condensed analysis, see my [custom Google Analytics dashboard](/blog/files/google-analytics-dashboard/).^[Thanks to the [RStudio blog](https://blog.rstudio.com/2021/01/06/google-analytics-part2/){target="_blank"} for the inspiration.]
