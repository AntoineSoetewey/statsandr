...
For interested readers, the [`{compareGroups}` package](https://cloud.r-project.org/web/packages/compareGroups/index.html){target="_blank"} also provides a nice way to compare groups. It comes with a really complete Shiny app, available with:
