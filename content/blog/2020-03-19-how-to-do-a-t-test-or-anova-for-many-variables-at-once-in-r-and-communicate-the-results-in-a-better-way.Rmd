...
df <- data.frame(Variable = names(dat[, 1:4]),
...
* Add the possibility to choose a *p*-value adjustment method. Currently, raw *p*-values are displayed in the graphs and I manually adjust them.
