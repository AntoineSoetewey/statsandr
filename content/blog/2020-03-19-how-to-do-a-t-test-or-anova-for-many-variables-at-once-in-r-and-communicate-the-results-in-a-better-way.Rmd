...
Based on these graphs, it is easy, even for non-experts, to interpret the results and conclude that the `versicolor` and `virginica` species are significantly different in terms of all 4 variables (since *p*-values $< \frac{0.05}{4} = 0.0125$ (remind that we divide the usual $\alpha$ level by 4 because there are 4 t-tests)).
