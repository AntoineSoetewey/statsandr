...
I will try to add these features in the future, or I would be glad to help if the developer of the {ggpubr} package needs help in including these features.

Thanks for reading. I hope this article will help you to perform t-tests and ANOVA for multiple variables at once and make the results more easily readable and interpretable by nonscientists. Learn more about the t-test in [this article](/blog/student-s-t-test-in-r-and-by-hand-how-to-compare-two-groups-under-different-scenarios/).
