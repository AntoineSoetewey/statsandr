...
The Dunn test being the most common one, here is how to do it in R.^[Note Note that there are other *p*-value adjustment methods. See `?dunnTest` for more options.]
