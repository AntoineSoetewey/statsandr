...
There exists five main methods to measure the distance between clusters, referred as linkage methods:
...
![Determining the optimal numbers of cluster in hierarchical clustering. Source: Towards Data Science](/blog/clustering-analysis-k-means-and-hierarchical-clustering-by-hand-and-in-r_files/optimal number of clusters hierarchical clustering.png){width=100%}
