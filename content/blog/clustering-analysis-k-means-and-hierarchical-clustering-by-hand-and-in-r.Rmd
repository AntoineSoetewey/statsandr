...
Using the data from the graph and the table below, perform **by hand** the 3 algorithms (single, complete and average linkage). Then **check** your answers **in R** and draw the dendrogram.
...
#Ward's algorithm and dendrogram #
