...
![Photo by Helloquence](/blog/how-to-construct-a-timeline-of-your-cv-in-r_files/how-to-create-a-timeline-of-your-cv.jpeg){width=100%}
...
We show below how to create such CV in R with a minimal reproducible example. Feel free to use the code and adapt it to you. For a more complete example (together with the code) you can check my own CV timeline <a href="https://www.antoinesoetewey.com/files/CV_timeline_antoinesoetewey.html" target="_blank" rel="noopener">here</a>.
