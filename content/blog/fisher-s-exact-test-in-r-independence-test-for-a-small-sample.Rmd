...
Thanks for reading. I hope the article helped you to perform the Fisher's exact test of independence in R and interpret its results. Learn more about the Chi-square test of independence [by hand](/blog/chi-square-test-of-independence-by-hand/) or [in R](/blog/chi-square-test-of-independence-in-r/). As always, if you have a statistical question related to this article, please add it as a comment so other readers can benefit from the discussion. If you find a mistake or bug, you can inform me by <a href="https://github.com/AntoineSoetewey/statsandr/issues" target="_blank" rel="noopener">raising an issue on GitHub</a>. For all other requests, you can contact me [here](/contact/). Get updates every time a new article is published by [subscribing to this blog](/subscribe/).
