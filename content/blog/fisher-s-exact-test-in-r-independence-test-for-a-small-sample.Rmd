...
To perform the Fisher's exact test in R, use the `fisher.test()` function:^[Use `fisher.test(table(dat$variable1, dat$variable2))` if `dat` represent the raw data and is not already presented as a contingency table.] 
