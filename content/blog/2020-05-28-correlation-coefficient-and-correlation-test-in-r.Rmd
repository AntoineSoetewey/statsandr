...
The `correlation` function from the [easystats `{correlation}` package](https://easystats.github.io/correlation/){target="_blank"} allows to combine correlation coefficients and correlation tests in a single table:
