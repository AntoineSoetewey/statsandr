...
We now have all the necessary information to find the critical value in the Chi-square table ($\alpha = 0.05$ and $df = 1$). To find the critical value we need to look at the row $df = 1$ and the column $\chi^2_{0.950}$ (since $\alpha = 0.05$). The critical value is $3.84146$.
...
Now that we have the test statistic and the critical value, we can compare them to conclude about the dependence or independence of the two variables. In our example,
