...
We have the observed and expected frequencies. We now need to compare these frequencies to determine whether they significantly differ. The difference between the frequencies, referred as the test statistic and denoted $\chi^2$, is computed as follows:
...
We now have all the necessary information to find the critical value in the Chi-square table ($\alpha = 0.05$ and $df = 1$). Below a picture of this table. You can find it online or in many statistical textbooks.

![Chi-square probability distribution](/blog/chi-square-test-of-independence-by-hand_files/Screenshot 2020-01-27 at 17.40.58.png)

xxx

![Critical value for alpha = 5% and df = 1](/blog/chi-square-test-of-independence-by-hand_files/chi-square-table.png)
