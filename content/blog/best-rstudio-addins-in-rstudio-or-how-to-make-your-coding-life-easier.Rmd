...
See this [guide](https://rstudio.github.io/rstudioaddins/#registering-addins) if you want to install a personal package as addin. In short, you have to create an R package, put your functions in a specific file and RStudio will automatically discover and register these addins when your package is installed.
