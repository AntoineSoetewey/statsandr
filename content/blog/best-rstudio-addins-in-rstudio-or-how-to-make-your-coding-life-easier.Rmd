...
For the sake of illustration, let's say we want to create a scatter plot of the variables `Sepal.Length` and `Petal.Length` of the dataset `iris` and color the points by the variable `Species`. For this, follow these steps:
