...
description: Discover the RStudio addins esquisse, questionr, remedy, styler, snakecaser and blogdown, how to use them in practice and how they can help when coding in R.
output:
  blogdown::html_page:
    toc: true
    toc_depth: 6
...
![Photo by Safar Safarov](/blog/best-rstudio-addins-in-rstudio-or-how-to-make-your-coding-life-easier_files/rstudio-addins.jpeg){width=100%}
...
`{esquisse}` is an addin developed by a French company called [dreamRs](https://www.dreamrs.fr/). Here is how they define it:
...
![](/blog/best-rstudio-addins-in-rstudio-or-how-to-make-your-coding-life-easier_files/Screenshot 2020-03-11 at 18.09.59.png)
...
Thanks for reading. I hope that you will find these addins useful for your future R-related projects. See other [tips and tricks in RStudio and R Markdown](/blog/tips-and-tricks-in-rstudio-and-r-markdown/).
